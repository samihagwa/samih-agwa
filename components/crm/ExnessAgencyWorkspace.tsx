...
export function ExnessAgencyWorkspace() {
  ...
  return <section className="exness-agency-workspace">
    ...
    <section className="exness-lookup-panel" aria-labelledby="exness-lookup-title">
      <div><p className="overline">Client check</p><h2 id="exness-lookup-title">هل الحساب تحت وكالتنا؟</h2><p>ابحث برقم حساب Exness أو Client UID. موظف السيلز لن يرى اللوتات أو العمولة.</p></div>
