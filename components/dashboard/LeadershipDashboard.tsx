...
export function LeadershipDashboard() {
  ...
  return <section className="leadership-dashboard">
    ...
    {manager ? <section className="panel readiness-panel">
      ...
      <aside className="readiness-external-note"><ShieldCheck size={17} /><p><strong>تبقى موافقتك لاحقًا:</strong> فتح وصول الموقع، ضبط الدومين والبريد، تدوير توكن Telegram، ثم تجربة حساب عضو واحد. النظام لن ينفذ أيًا منها تلقائيًا.</p></aside>
    </section> : null}
  </section>;
}
