...
function commandError(error: { message: string } | null, fallback: string) {
  ...
  const translations: Array<[RegExp, string]> = [
    ...
    [/Only the assigned writer can add this script/i, "صاحب الاسكريبت المسند إليه فقط يقدر يضيفه إلى بصمته الخاصة."],
    [/Create your private writing voice first/i, "أنشئ بصمتك الخاصة من تبويب «بصمتي» أولًا."],
    [/Active Scripts access is required/i, "لازم تكون عضويتك فعالة وقسم الاسكريبتات مسموحًا لك."],
